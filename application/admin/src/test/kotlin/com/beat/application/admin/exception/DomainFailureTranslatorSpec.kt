...
class DomainFailureTranslatorSpec :
    FunSpec({
        test("domain failure를 원인과 domain code를 보존한 채 변환한다") {
            ...
            applicationFailure.errorCode.code shouldBe
                PromotionErrorCode.TOO_MANY_CAROUSEL_PROMOTIONS.code
            applicationFailure.errorCode.type shouldBe AdminApplicationErrorType.INVALID_INPUT
            applicationFailure.errorCode.message shouldBe
