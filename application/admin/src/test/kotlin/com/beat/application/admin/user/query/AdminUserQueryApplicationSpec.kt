...
class AdminUserQueryApplicationSpec :
    FunSpec({
...
private class StubMemberRepository(private val member: Member?) : MemberRepository {
...
private class RecordingUserRepository(private val users: List<Users>) : UserRepository {
    var findAllCalls: Int = 0
        private set

    override fun findById(id: Long): Users? = users.firstOrNull { it.id == id }
