...
class TicketCleanupApplicationSpec :
    FunSpec({
...
private class RecordingBookingRepository(private val queryResult: List<Booking>) :
    BookingRepository {
...
private fun cancelledBooking(id: Long): Booking =
    Booking.rehydrate(
        id = id,
