...
): BookingHistorySnapshot = BookingHistorySnapshot(
    userId = 7L,
    bookingId = bookingId,
...
private fun schedule(
    ...
    performanceId: Long,
    number: String,
): BookingHistoryScheduleSnapshot = BookingHistoryScheduleSnapshot(
...
private fun performance(
    performanceId: Long,
    ticketPrice: Int,
): BookingHistoryPerformanceSnapshot = BookingHistoryPerformanceSnapshot(
    performanceId = performanceId,
    performanceTitle = "공연",
