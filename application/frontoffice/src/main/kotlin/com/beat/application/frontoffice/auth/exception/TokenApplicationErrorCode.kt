...
internal enum class TokenApplicationErrorCode(
    ...
    REFRESH_TOKEN_NOT_FOUND("REFRESH_TOKEN_NOT_FOUND", FrontofficeApplicationErrorType.NOT_FOUND, "리프레쉬 토큰이 존재하지 않습니다"),
    INVALID_REFRESH_TOKEN_ERROR("INVALID_REFRESH_TOKEN", FrontofficeApplicationErrorType.INVALID_INPUT, "잘못된 리프레쉬 토큰입니다"),
    ...
    REFRESH_TOKEN_EXPIRED_ERROR("REFRESH_TOKEN_EXPIRED", FrontofficeApplicationErrorType.UNAUTHENTICATED, "리프레쉬 토큰이 만료되었습니다"),
    ...
    REFRESH_TOKEN_EMPTY_ERROR("REFRESH_TOKEN_EMPTY", FrontofficeApplicationErrorType.INVALID_INPUT, "리프레쉬 토큰이 비어있습니다"),
