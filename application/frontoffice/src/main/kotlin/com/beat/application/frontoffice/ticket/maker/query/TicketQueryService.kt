...
class TicketQueryService(
    ...
    fun findAllTicketsByConditions(
        ...
        val tickets = makerTicketReader.findTickets(
            performanceId,
    ...
    fun searchAllTicketsByConditions(
        ...
        val tickets = makerTicketReader.searchTickets(
            performanceId,
            searchWord,
    ...
    private fun validateDeletedTicketsAreNotRequested(bookingStatuses: List<String>) {
        if ("BOOKING_DELETED" in bookingStatuses) {
            throw FrontofficeApplicationException(TicketApplicationErrorCode.DELETED_TICKET_RETRIEVE_NOT_ALLOWED)
        }
    }
