...
enum class PerformanceImageApplicationErrorCode(
    ...
    PERFORMANCE_IMAGE_NOT_BELONG_TO_PERFORMANCE("PERFORMANCE_IMAGE_NOT_BELONG_TO_PERFORMANCE", FrontofficeApplicationErrorType.FORBIDDEN, "해당 싱세이미지는 해당 공연에 속해 있지 않습니다."),
