...
@ContextConfiguration(classes = [TaskExecutionAutoConfiguration::class, TaskExecutorConfig::class])
@TestPropertySource(
    properties =
        [
...
open class KotestSpringCoexistencePilotSpec : FunSpec() {
    @Autowired private lateinit var threadPoolProperties: ThreadPoolProperties
    ...
    init {
        ...
        context("Spring TestContext가 Kotest leaf lifecycle로 실행되면").config(
