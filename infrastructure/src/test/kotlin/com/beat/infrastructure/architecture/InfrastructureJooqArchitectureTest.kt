...
class InfrastructureJooqArchitectureTest : FunSpec({
    ...
    test("infrastructure jOOQ generated type는 infrastructure 내부에만 존재해야 한다 — E-08 guard") {
        ...
        // This test documents the contract; actual enforcement for App/Domain/Apps is in their own modules.
        // Here we ensure generated package is under infrastructure.
        val generatedClasses = productionClasses.filter { it.packageName.startsWith("com.beat.infrastructure.jooq.generated") }
    ...
    test("persistence/query는 JPA/JDSL/Spring Data 타입에 의존하지 않는다 — E-08 guard") {
        noClasses()
            .that().resideInAPackage("com.beat.infrastructure.persistence.query..")
            ...
            .because("persistence/query is jOOQ View Read only — JPA/JDSL is forbidden (I-20, E-08)")
