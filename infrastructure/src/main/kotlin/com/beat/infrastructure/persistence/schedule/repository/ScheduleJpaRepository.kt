package com.beat.infrastructure.persistence.schedule.repository
...
internal interface ScheduleJpaRepository : JpaRepository<ScheduleJpaEntity, Long> {

    @Lock(LockModeType.PESSIMISTIC_WRITE)
    @Query("SELECT s FROM Schedule s WHERE s.id = :id")
    fun lockById(@Param("id") id: Long): ScheduleJpaEntity?
