...
internal class MakerPerformanceListQueries(
    ...
    override fun findByUserId(userId: Long): List<MakerPerformanceListItemReadModel> {
        ...
        val representativeDates =
            findRepresentativeDates(performances.mapNotNull { it.performanceId }).associate {
                it.performanceId to it.performanceDate
            }
    ...
    private fun findRepresentativeDates(
        performanceIds: List<Long>
    ): List<RepresentativePerformanceDateProjection> {
        ...
        return dsl.select(
            ...
            .fetch { record ->
                RepresentativePerformanceDateProjection(
                    ...
                    performanceDate = record["performance_date", LocalDateTime::class.java]!!,
                )
            }
    }
