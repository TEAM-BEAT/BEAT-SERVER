...
/**
 * Hand-maintained jOOQ meta — checked-in generated source.
 * Source DDL: resources/db/jooq/schema.sql (MySQL 8, DATETIME(6) etc).
 * Build-logic `beat.jooq-codegen` documents the official DDLDatabase pipeline;
 * this file is the deterministic output of that pipeline and must stay in sync
 * with JPA entities. No outer module may import this package.
 */
object Booking {
    val TABLE: Table<*> = DSL.table(DSL.name("booking"))
    val ID: Field<Long?> = DSL.field(DSL.name("booking", "id"), SQLDataType.BIGINT.nullable(true))
...
object Schedule {
    ...
    val ID: Field<Long?> = DSL.field(DSL.name("schedule", "id"), SQLDataType.BIGINT.nullable(true))
...
object Performance {
    ...
    val ID: Field<Long?> = DSL.field(DSL.name("performance", "id"), SQLDataType.BIGINT.nullable(true))
    ...
    val PERFORMANCE_PERIOD: Field<String?> = DSL.field(DSL.name("performance", "performance_period"), SQLDataType.VARCHAR)
    val PERFORMANCE_START_DATE: Field<LocalDate?> = DSL.field(DSL.name("performance", "performance_start_date"), SQLDataType.LOCALDATE.nullable(true))
    val PERFORMANCE_END_DATE: Field<LocalDate?> = DSL.field(DSL.name("performance", "performance_end_date"), SQLDataType.LOCALDATE.nullable(true))
...
object Promotion {
    ...
    val ID: Field<Long?> = DSL.field(DSL.name("promotion", "id"), SQLDataType.BIGINT.nullable(true))
...
object CastTable {
    ...
    val ID: Field<Long?> = DSL.field(DSL.name("cast", "id"), SQLDataType.BIGINT.nullable(true))
...
object StaffTable {
    ...
    val ID: Field<Long?> = DSL.field(DSL.name("staff", "id"), SQLDataType.BIGINT.nullable(true))
...
object PerformanceImage {
    ...
    val ID: Field<Long?> = DSL.field(DSL.name("performance_image", "id"), SQLDataType.BIGINT.nullable(true))
