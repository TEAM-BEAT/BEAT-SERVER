...
internal class CoolSmsAdapter {
    @field:Value("\${spring.coolsms.api.key}") private lateinit var apiKey: String

    @field:Value("\${spring.coolsms.api.secret}") private lateinit var apiSecret: String

    @field:Value("\${spring.coolsms.api.number}") private lateinit var fromPhoneNumber: String
