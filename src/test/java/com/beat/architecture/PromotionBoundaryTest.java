...
class PromotionBoundaryTest {
	...
	void domainPromotionBoundaryShouldNotImportAdminDto() throws Exception {
		String port = Files.readString(Path.of("src/main/java/com/beat/domain/promotion/port/in/PromotionUseCase.java"));
		String service = Files.readString(
			Path.of("src/main/java/com/beat/domain/promotion/application/PromotionService.java"));
