...
public interface TicketRepository extends JpaRepository<Booking, Long> {
	...
	List<Booking> findBySchedulePerformanceIdAndScheduleScheduleNumber(Long performanceId,
		ScheduleNumber scheduleNumber);

	List<Booking> findBySchedulePerformanceIdAndBookingStatus(Long performanceId, BookingStatus bookingStatus);

	List<Booking> findBySchedulePerformanceIdAndScheduleScheduleNumberAndBookingStatus(Long performanceId,
