            ...
            MakerPerformanceDetailResponse(
                performanceId =
                    requireNotNull(result.performanceId) {
                        "MakerPerformanceDetailResponse.performanceId must be present for a persisted performance"
                    },
                genre =
                    requireNotNull(result.genre) {
                        "MakerPerformanceDetailResponse.genre must be present"
                    },
                performanceTitle =
                    requireNotNull(result.performanceTitle) {
                        "MakerPerformanceDetailResponse.performanceTitle must be present"
                    },
                posterImage =
                    requireNotNull(result.posterImage) {
                        "MakerPerformanceDetailResponse.posterImage must be present"
                    },
                performancePeriod =
                    requireNotNull(result.performancePeriod) {
                        "MakerPerformanceDetailResponse.performancePeriod must be present"
                    },
