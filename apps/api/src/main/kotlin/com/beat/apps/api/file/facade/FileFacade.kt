...
@Service
class FileFacade(private val fileCommandService: FileCommandService) {
    fun issueAllPresignedUrlsForPerformanceMaker(
        ...
        PerformanceMakerPresignedUrlFindAllResponse.from(
            performanceMakerPresignedUploads =
                fileCommandService
                    .issueAllPresignedUrlsForPerformanceMaker(
                        posterImage,
                        castImages,
                        staffImages,
                        performanceImages,
