...
class CdnImageUrlSerializerSpec :
    FunSpec({
        ...
        test("절대 URL과 빈 값은 그대로 유지된다") {
            ...
            objectMapper.writeValueAsString(
                ImageResponse("https://external.test/image.jpg")
            ) shouldBe """{"imageUrl":"https://external.test/image.jpg"}"""
            objectMapper.writeValueAsString(ImageResponse("")) shouldBe """{"imageUrl":""}"""
        }
    })

private data class ImageResponse(@get:CdnImageUrl val imageUrl: String)
