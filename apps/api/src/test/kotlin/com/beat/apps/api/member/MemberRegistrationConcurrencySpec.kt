...
open class MemberRegistrationConcurrencySpec : FunSpec() {
    @Autowired private lateinit var socialLoginCommandService: SocialLoginCommandService
    ...
    init {
        ...
        test("동일 Social identity 동시 로그인은 한 회원만 등록하고 두 요청 모두 정상 반환한다") {
            ...
            try {
                ...
                checkNotNull(memberRepository.findBySocialIdentity(socialIdentity))
                    .socialIdentity shouldBe socialIdentity
            } finally {
    ...
    private fun countMembers(socialIdentity: SocialIdentity): Int =
