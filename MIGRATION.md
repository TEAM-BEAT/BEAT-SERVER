...
- `domain` 안의 JPA entity / Spring Data repository / QueryDSL projection은 slice migration을 통해 제거되었고,
  현재 남은 persistence concern은 auditing mapped superclass인 `BaseTimeEntity` 하나로 축소되었다.
