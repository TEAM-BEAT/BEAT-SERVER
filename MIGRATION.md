...
- `domain/src/main/java/com/beat/domain/booking/repository/BookingRepository.java`는 command-side repository port로 남고, `TicketRepository.java`는 제거되었습니다. maker ticket 조회는 module-contracts read port가 소유합니다.
