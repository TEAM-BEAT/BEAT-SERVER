...
| Exception/ErrorCode | `domain/<context>/exception` | domain 규칙 위반을 표현하는 코드 |
...
domain/
  src/main/java/com/beat/domain/<context>/
    ...
    exception/    # domain error/success code
...
## 6. Domain model은 어디까지 올라갈 수 있는가
