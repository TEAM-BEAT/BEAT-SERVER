...
public class ScheduleRepositoryCustomImpl implements ScheduleRepositoryCustom {
	...
	public List<MinPerformanceDateDto> findMinPerformanceDateByPerformanceIds(List<Long> performanceIds) {
		...
		DateTimeExpression<LocalDateTime> futureMin = Expressions.cases()
		...
		DateTimeExpression<LocalDateTime> pastMin = Expressions.cases()
		...
		DateTimeExpression<LocalDateTime> finalPerformanceDate = Expressions.cases()
