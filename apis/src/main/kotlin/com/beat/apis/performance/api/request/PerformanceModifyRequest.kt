...
data class PerformanceModifyRequest(
    ...
    val scheduleModifyRequests: List<@NotNull @Valid ScheduleModifyRequest>?,
    @field:NotNull @field:Valid val castModifyRequests: List<@NotNull @Valid CastModifyRequest>?,
    @field:NotNull @field:Valid val staffModifyRequests: List<@NotNull @Valid StaffModifyRequest>?,
    @field:NotNull @field:Valid
    val performanceImageModifyRequests: List<@NotNull @Valid PerformanceImageModifyRequest>?,
)
