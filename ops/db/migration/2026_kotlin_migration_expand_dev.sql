...
-- =============================================================================
-- 이 파일은 ops/db/migration/2026_kotlin_migration_expand_prod.sql 과 반드시
...
--   mysql -h <dev-db-endpoint> -u <user> -p beatDev < ops/db/migration/2026_kotlin_migration_expand_dev.sql
--
-- 배포 순서(반드시 지킬 것):
