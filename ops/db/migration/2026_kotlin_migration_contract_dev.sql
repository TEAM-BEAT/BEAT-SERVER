...
-- =============================================================================
-- 이 파일은 ops/db/migration/2026_kotlin_migration_contract_prod.sql 과 반드시
...
--
-- 실행:
--   mysql -h <dev-db-endpoint> -u <user> -p beatDev < ops/db/migration/2026_kotlin_migration_contract_dev.sql
-- =============================================================================
